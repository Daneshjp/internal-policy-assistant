    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      >
        <div className="text-white">
          <h1 className="text-5xl font-bold mb-4">InspectionAgent</h1>
          ...
          <div className="space-y-3 text-blue-100">
            <div className="flex items-center space-x-3">
              ...
              <p>Streamlined inspection workflows</p>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-300 rounded-full"></div>
              <p>Mobile-optimized field execution</p>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-300 rounded-full"></div>
      ...
      >
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>Sign in to your InspectionAgent account</CardDescription>
          </CardHeader>
          <CardContent>
